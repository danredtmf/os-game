...
const user_res = preload('res://objects/user_panel_select/user_panel_select.tscn')
...
onready var win_user_select = $WinUserSelect
onready var win_user_select_list = $WinUserSelect/Margin/VB/Scroll/Margin/VB

onready var win_logon = $WinLogon
onready var win_logon_back = $WinLogon/Margin/VB/HB/Back
onready var win_logon_login = $WinLogon/Margin/VB/VB/Login/Edit
onready var win_logon_password = $WinLogon/Margin/VB/VB/Pass/Edit

onready var win_power = $WinPower

onready var anim_wus = $AnimationWinUserSelect
onready var anim_logon = $AnimationLogon
onready var anim_power = $AnimationPower
onready var anim_bg = $AnimationBG
onready var anim_info = $AnimationInfo
