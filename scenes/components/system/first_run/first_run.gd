...
onready var win_name = $WinName
onready var edit_name = $WinName/Margin/VB/Name/Edit
onready var btn_next_new_user = $WinName/Margin/VB/NextNewUser

onready var win_new_user = $WinNewUser
onready var edit_login = $WinNewUser/Margin/VB/VB/Login/Edit
onready var edit_password = $WinNewUser/Margin/VB/VB/Pass/Edit

onready var anim_bg = $AnimationBG
onready var anim_info = $AnimationInfo
onready var anim_wn = $AnimationWinName
onready var anim_wnu = $AnimationWinNewUser
